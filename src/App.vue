<template>
  ...
  <section className="flex flex-col h-[540px] max-w-[480px] p-4 my-6 mx-auto bg-gray-100 rounded-xl shadow-md">
    ...
    <ShoppingLists v-if="shoppingList.length > 0" :shopping-list="shoppingList" />
    <div v-else className="size-full flex justify-center items-center text-base font-semibold">
